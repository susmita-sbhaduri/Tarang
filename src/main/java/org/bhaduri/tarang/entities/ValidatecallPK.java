 ...
 */
@Embeddable
public class ValidatecallPK implements Serializable {
    ...
    public ValidatecallPK() {
    }

    public ValidatecallPK(String scripid, Date lastupdateminute) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ValidatecallPK)) {
            return false;
        }
        ValidatecallPK other = (ValidatecallPK) object;
    ...
    public String toString() {
        return "org.bhaduri.tarang.entities.ValidatecallPK[ scripid=" + scripid + ", lastupdateminute=" + lastupdateminute + " ]";
    }
