...
public class CalltableJpaController implements Serializable {
    ...
    public CalltableJpaController(UserTransaction utx, EntityManagerFactory emf) {
        this.utx = utx;
        this.emf = emf;
    }
    ...
    public void create(Calltable calltable) throws PreexistingEntityException, RollbackFailureException, Exception {
    ...
    public void edit(Calltable calltable) throws NonexistentEntityException, RollbackFailureException, Exception {
        EntityManager em = null;
        try {
            utx.begin();
            em = getEntityManager();
    ...
    public void destroy(CalltablePK id) throws NonexistentEntityException, RollbackFailureException, Exception {
        EntityManager em = null;
        try {
            utx.begin();
            em = getEntityManager();
